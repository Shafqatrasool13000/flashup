...
export const ProtocolContextData = createContext<Context_Api_Data>({} as Context_Api_Data);

const ProtocolsContextProvider: React.FC<ProtocolContextProps> = ({ children }) => {
  ...
  const [flashLoanItems, setFlashLoanItems] = useState<any>([]);
    ...
    setSavedProtocols([
      {
        ...
        tag: '',
        protocolName: 'Aave',
        protocolIcon: 'cryptocurrency:aave',
        protocolLogo: '',
        initialData: {
          token: 'DAI',
          amount: 12,
        ...
        encodeData:
          '',
        protocol_id: ':r5:'
      },
      {
        name: 'Withdraw',
      ...
      },
      {
        ...
        encodeData:
          '0xf45346dc00000000000000000000000075ab5ab1eef154c0352fc31d2428cef80c7f8b33000000000000000000000000000000000000000000000000a688906bd8b00000000000000000000000000000f53113958d08876d3e421917adec43fce599cd43'
      },
      {
        'flashLoan-end': true,
  ...
  return <ProtocolContextData.Provider value={data}>{children}</ProtocolContextData.Provider>;
};
