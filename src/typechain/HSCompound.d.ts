...
export class HSCompound extends BaseContract {
  ...
  functions: {
    ...
    borrow(
      ...
      cTokenIn: string,
      cTokenBorrow: string,
      cAmountIn: BigNumberish,
      uBorrowAmount: BigNumberish,
      needEnterMarket: boolean,
    ...
    repayBorrow(
      dsProxy: string,
      cTokenRepay: string,
      cTokenWithdraw: string,
      uRepayAmount: BigNumberish,
      cWithdrawAmount: BigNumberish,
      overrides?: PayableOverrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    claimComp(dsProxy: string, overrides?: CallOverrides): Promise<BigNumber>;
